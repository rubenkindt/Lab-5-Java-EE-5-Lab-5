...
public class RentalStore {
    ...
    private static Map<String, CarRentalCompany2> rentals;

    public static CarRentalCompany2 getRental(String company) {
        CarRentalCompany2 out = RentalStore.getRentals().get(company);
        if (out == null) {
    ...
    public static synchronized Map<String, CarRentalCompany2> getRentals(){
        if(rentals == null){
            rentals = new HashMap<String, CarRentalCompany2>();
    ...
    public static void loadRental(String datafile) {
        try {
            ...
            CarRentalCompany2 company = new CarRentalCompany2(data.name, data.regions, data.cars);
        ...
        try {
            while (in.ready()) {
                ...
                if (line.startsWith("#")) {
                    ...
                    CarType2 type = new CarType2(csvReader.nextToken(),
                    ...
                    for (int i = Integer.parseInt(csvReader.nextToken()); i > 0; i--) {
                        out.cars.add(new Car2(nextuid++, type));
                    }        
                }
            } 
        } finally {
