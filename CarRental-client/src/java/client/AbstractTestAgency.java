...
public abstract class AbstractTestAgency<ReservationSession, ManagerSession> extends AbstractTesting {
     ...
     * companies managed by the rental agency).
     *
     ...
     * at a particular car rental company.
     *
     * @param ms manager session
